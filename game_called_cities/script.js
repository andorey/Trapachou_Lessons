    ...
    field.addEventListener('keypress', function (event) {
        ...
        if (event.key === 'Enter') {
            ...
            if (arrCities.includes(letter) && (lastChapter === firstChapter || lastChapter === 0)) {
                ...
                let cityNames = arrCities.filter(el => el.toLowerCase()[0] === lastLetter)
                ...
                message.classList.add('error');
                message.innerText = 'Первая буква наименования вашего города \n должна соответствовать последней, предложенной компютером \n Попробуйте еще раз'
